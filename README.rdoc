...
{<img src="https://travis-ci.org/Undev/redmine_tagging.png" alt="Build Status" />}[https://travis-ci.org/Undev/redmine_tagging]
{<img src="https://codeclimate.com/github/Undev/redmine_tagging.png" />}[https://codeclimate.com/github/Undev/redmine_tagging]
...
1)
  $ rake acts_as_taggable_on_engine:install:migrations RAILS_ENV=production
2)
