...
This plugin needs acts-as-taggable-on from rymai
...
The plugin also needs rails_sql_views. It might install automatically
by just doing 'gem install rails_sql_views'. If not (it didn't for me when 0.7.0 was available),
try:
